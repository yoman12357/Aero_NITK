...
// CHECK DUPLICATE WORKSHOP REGISTRATION
export const checkDuplicateRegistration = async ({ rollNo, email, phone }) => {
...
export const checkEmailExists = async (email) => {
  ...
  try {
    ...
    const ref = doc(db, "applicants", email);
...
// SAVE RECRUITMENT APPLICANT (EMAIL AS DOC ID)
export const saveApplicant = async (data) => {

  try {

    const ref = doc(db, "applicants", data.email);
