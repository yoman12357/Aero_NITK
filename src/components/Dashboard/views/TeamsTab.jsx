...
function TeamsTab() {
    ...
    const handleEdit = (member) => {
        ...
        setForm({
            ...
            teamType: member.teamType || 'Member',
            subsystem: member.subsystem || '',
            role: member.role || member.post || ''
        });

        // Existing Sanity image
        const existingImage = member.image || member.photo;

        setPhotoPreview(getImageUrl(existingImage));

        // Important:
        // We DON'T set selectedFile here.
        // Existing image will remain unless user chooses a new one.
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            // If deleting currently edited member
            if (
                editingMember &&
                (editingMember._id || editingMember.id) === id
            ) {
                resetForm();
            }
                ...
                <div className="teams-form-card">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="teams-form-group">
                            ...
                            {editingMember && (
                                <small>
                                    Leave the photo unchanged if you
